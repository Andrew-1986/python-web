...
where g.group_name = 'Group-2' and sub.subject_name = 'English';
...
join subject sub on m.id_subject = sub.id
join "groups" g on stud.id_group = g.id
where sub.subject_name = 'Mathematic' and g.group_name = 'Group-1'
...
join subject sub on m.id_subject = sub.id
join "groups" g on stud.id_group = g.id
where sub.subject_name = 'Mathematic' and g.group_name = 'Group-1' and mark_date = '2021-05-28';
...
where stud.full_name = 'Jack Black';
...
join student stud on m.id_student = stud.id
join subject sub on m.id_subject = sub.id
where t.full_name = 'John Week' and stud.full_name = 'Jack Black'
...
where t.full_name = 'John Week' and s.full_name = 'Freddy Krueger';
